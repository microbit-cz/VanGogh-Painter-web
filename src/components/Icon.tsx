...
export const Icon: FC<IconProps> = ({ variant }) => {
    switch (IconVariant[variant]) {
        ...
        case IconVariant.BLUETOOTH:
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M11 22v-7.6L6.4 19L5 17.6l5.6-5.6L5 6.4L6.4 5L11 9.6V2h1l5.7 5.7l-4.3 4.3l4.3 4.3L12 22zm2-12.4l1.9-1.9L13 5.85zm0 8.55l1.9-1.85l-1.9-1.9z"/>
                </svg>
            );
        ...
        case IconVariant.MINUS:
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="em" viewBox="0 0 24 24">
